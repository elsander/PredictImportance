...
#' @export
discreteLV_C <- function(r_, alphas_, n0s_, Is_, deltat, simtime) {
    .Call('predictimportance_discreteLV_C', PACKAGE = 'predictimportance', r_, alphas_, n0s_, Is_, deltat, simtime)
}
